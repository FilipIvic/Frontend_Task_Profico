...
export const navTabs = [
    ...
    {page: 'General', link: '/general', icon: generalIcon, activeIcon: activeHomeIcon},
    {page: 'Business', link: '/business', icon: businessIcon, activeIcon: activeHomeIcon},
    {page: 'Health', link: '/health', icon: healthIcon, activeIcon: activeHomeIcon},
    {page: 'Science', link: '/science', icon: scienceIcon, activeIcon: activeHomeIcon}, 
    {page: 'Sports', link: '/sports', icon: sportsIcon, activeIcon: activeHomeIcon}, 
    {page: 'Technology', link: '/technology', icon: technologyIcon, activeIcon: activeHomeIcon}
  ]
